      ...
      {predictionResult && (
        ...
        >
          <h3>
            ...
            {predictionResult.modelUsed || // Usa questo se disponibile dalla risposta API
              availableModelsList.find((m) => m.id === selectedModelId)?.name || // Altrimenti, cerca nella lista dei modelli
              selectedModelId}{" "}
